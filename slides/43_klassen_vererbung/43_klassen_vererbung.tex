...
%
\only<-11>{%
\item<3-> Während wir das gemacht haben, haben wir gesehen, wir Methoden auf eine abstrakte Art in einer Basisklasse definiert und dann in Subklassen implementiert werden können.%
}%
%
\only<-12>{%
